...
type CommonOptions = Partial<{
    ...
    img_bg: string;
    img_position: "top" | "right top" | "right" | "right bottom" | "bottom" | "left bottom" | "left" | "left top" | "center" | "centre" | "north" | "northeast" | "east" | "southeast" | "south" | "southwest" | "west" | "northwest" | "center" | "centre" | "entropy" | "attention";
    srgb: boolean;
    rgb: boolean;
    gamma24: boolean;
...
declare const formats: readonly ["png", "jpg", "jpeg", "pdf", "avif", "mp4", "webm", "webp", "html", "mhtml", "svg", "md"];
declare const pdfPageSize: readonly ["a4", "a0", "a1", "a2", "a3", "a4", "a5", "a6", "legal", "ledger", "letter", "tabloid"];
declare const storageClasses: readonly ["standard", "reduced_redundancy", "standard_ia", "onezone_ia", "intelligent_tiering", "glacier", "deep_archive", "outposts"];
declare const colorProfiles: readonly ["default", "srgb", "dp3", "rec2020", "scrgblinear", "hdr10", "colorspingamma24"];
declare const waitUntil: readonly ["domloaded", "mostrequestsfinished", "requestsfinished", "loaded"];
declare const pdfOrientationEnum: readonly ["portrait", "landscape"];
declare const pdfMarginEnum: readonly ["default", "none", "minimum"];
declare const mediaOptionsEnum: readonly ["print", "screen"];
declare const fullPageMode: readonly ["stitch", "native"];
declare const videoPresets: readonly ["ultrafast", "superfast", "veryfast", "faster", "fast", "medium", "slow", "slower", "veryslow"];
declare const easingFunctions: readonly ["linear.none", "linear.in", "linear.out", "linear.inout", "quadratic.in", "quadratic.out", "quadratic.inout", "cubic.in", "cubic.out", "cubic.inout", "quartic.in", "quartic.out", "quartic.inout", "quintic.in", "quintic.out", "quintic.inout", "sinusoidal.in", "sinusoidal.out", "sinusoidal.inout", "exponential.in", "exponential.out", "exponential.inout", "circular.in", "circular.out", "circular.inout", "elastic.in", "elastic.out", "elastic.inout", "back.in", "back.out", "back.inout", "bounce.in", "bounce.out", "bounce.inout"];
export {};
